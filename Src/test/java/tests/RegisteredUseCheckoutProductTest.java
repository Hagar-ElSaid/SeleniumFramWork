...
public class RegisteredUseCheckoutProductTest extends TestBase {
	...
	String email ="hagar9505@gmail.com";
	...
	public void UserCanRegisterSucess() {
		...
		registerobject.UserRegistration("Hagar", "ELSaid", email, password);
	...
	public void UserCanCheckout () throws InterruptedException {
		...
		checkoutobject.CheckoutProduct ("Canada","Quebec",City, Address1, PostCode, phone);
